...
namespace SpearPay.Helper
{
    ...
    public static class EncryptHelper
    {
        ...
        {
            return Rsa(data, privateKey, DefaultCharset, signType, false);
        }
        ...
        {
            return RSAVerifyData(data, sign, publicKey, DefaultCharset, signType, false);
        }
        ...
        private static System.Security.Cryptography.RSA LoadCertificateFile(string filename, string signType)
        {
